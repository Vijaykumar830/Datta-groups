...
const Contact = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Ongoing assistance included",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Ready to discuss your trading or technology needs? Our experienced
              team is here to provide personalized solutions and expert guidance
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (info.title === "Email Address")
                        ...
                        window.location.href = `tel:+919703462727`;
                    }}
                  >
                    {info.action}
                  </Button>
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  within 24 hours with a customized solution for your needs.
                </p>

                {/* Google Form Link Button */}
                <Button asChild className="btn-gold mb-6 text-black">
                  <a
                    href="https://forms.gle/n9fxGTMnfm2YorCW6"
                    target="_blank"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleInputChange}
                        placeholder="Describe your requirements, timeline, and any specific questions you have..."
                        rows={6}
                        required
                      />
                    </div>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          (window.location.href =
                            "mailto:aravindhdattagroups@gmail.com")
                        }
                      >
                        Email
                      </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Located in Anakapalli, Andhra Pradesh, we're easily accessible and
              welcome visitors during business hours.
            </p>
          </div>
